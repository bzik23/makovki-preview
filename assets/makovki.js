...
(function () {
  ...
  /* ===========================================================================
     ...
     כרגע 8 (לפי הערת הלקוח 07/2026), ומ-01/01/2027 יעלה ל-9 לבד (בלי עדכון ידני).
     מקור אמת יחיד: כל מקום שמציג את המספר מסומן ב-.mk-exp-num (טקסט)
     או ב-data-exp (מונה מונפש) ומתעדכן מכאן.
     =========================================================================== */
  var MK_EXP_YEARS = 8;                 // ערך בסיס (עד תאריך המעבר)
  var MK_EXP_BUMP_DATE = "2027-01-01";  // מתאריך זה ואילך המספר עולה ב-1 (ל-9)
  function mkExpYears() {
